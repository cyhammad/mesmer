...
import ScheduleStoryDialog from "./ScheduleStoryDialog";
        ...
        <div className="p-4 sm:p-5 border-t border-[#F3F4F6] flex flex-col sm:flex-row items-center sm:justify-between gap-3 bg-white shrink-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto order-1 sm:order-2">
            <DialogClose asChild>
              <Button
                variant="outline"
                className="flex-1 sm:flex-none w-auto sm:w-[80px] h-[42px] rounded-full border-[#8F00FF] text-[#8F00FF] hover:bg-[#F3E8FF] hover:text-[#8F00FF] text-[14px] font-bold"
              >
                Cancel
              </Button>
            </DialogClose>
